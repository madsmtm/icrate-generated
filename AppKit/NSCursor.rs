...
pub enum NSCursorFrameResizePosition {
    ...
    TopLeft = NSCursorFrameResizePosition::Top.0 | NSCursorFrameResizePosition::Left.0,
    #[doc(alias = "NSCursorFrameResizePositionTopRight")]
    TopRight = NSCursorFrameResizePosition::Top.0 | NSCursorFrameResizePosition::Right.0,
    #[doc(alias = "NSCursorFrameResizePositionBottomLeft")]
    BottomLeft = NSCursorFrameResizePosition::Bottom.0 | NSCursorFrameResizePosition::Left.0,
    #[doc(alias = "NSCursorFrameResizePositionBottomRight")]
    BottomRight = NSCursorFrameResizePosition::Bottom.0 | NSCursorFrameResizePosition::Right.0,
}
