...
extern_methods!(
    unsafe impl CLServiceSession {
        ...
        #[cfg(feature = "block2")]
        #[method_id(@__retain_semantics Other sessionRequiringAuthorization:queue:handler:)]
        ...
        #[cfg(feature = "block2")]
        #[method_id(@__retain_semantics Other sessionRequiringAuthorization:fullAccuracyPurposeKey:queue:handler:)]
